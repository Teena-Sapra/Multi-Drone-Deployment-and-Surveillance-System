...
parser.add_argument('--source', help='Image source, can be image file ("test.jpg"), \
                    image folder ("test_dir"), video file ("testvid.mp4"), index of USB camera ("usb0"), index of Picamera ("picamera0"), or Arducam ("arducam0")', 
                    required=True)
...
# Parse input to determine if image source is a file, folder, video, or USB/CSI camera
